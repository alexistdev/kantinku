...
public class menuMerchant extends Fragment implements MenuMerchantAdapter.ClickListener {
    ...
    private void setupRecyclerView() {
        ...
        menuMerchantAdapter = new MenuMerchantAdapter(daftarMenu,this);
    ...
    public void dataItemKeranjang(String idItem) {
        SharedPreferences sharedPreferences = requireContext().getSharedPreferences(
                Constants.KEY_USER, Context.MODE_PRIVATE);
        String idUser = sharedPreferences.getString("idUser", "");
        this.doDelete(idItem,idUser,getContext());
    }

    private void doDelete(String idMenu,String idUser,Context mContext)
    {
        this.showDialog();
        try{
            Call<MenuModel> call = APIService.Factory.create(mContext).deleteMenu(idMenu);
            call.enqueue(new Callback<MenuModel>() {
                ...
                public void onResponse(Call<MenuModel> call, Response<MenuModel> response) {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            ...
                            HelperUtils.pesan(mContext,"Data menu berhasil dihapus");
                        }
                    } else {
                ...
                public void onFailure(Call<MenuModel> call, Throwable t) {
                    ...
                    if (t instanceof NoConnectivityException) {
                        HelperUtils.pesan(getContext(), t.getMessage());
                    }
                }
            });
